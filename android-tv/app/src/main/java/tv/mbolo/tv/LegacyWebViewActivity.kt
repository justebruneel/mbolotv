...
/**
 * FALLBACK TEMPORAIRE (Phase 5 §51) : ancien wrapper TV repris verbatim
 * (WebView système + secours GeckoView, classe renommée, layout dupliqué).
 * Accessible depuis l'UI native via « Secours web ». À SUPPRIMER uniquement
 * après validation réelle du chemin natif sur appareils cibles.
 */
class LegacyWebViewActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        hideSystemBars()
        setContentView(R.layout.activity_legacy_webview)
