...
export class ChannelsController {
  ...
  @Get(':id/epg')
  epg(@Param('id') id: string): Promise<Programme[]> {
    return this.channelsService.epg(id);
  }

  @Get(':id/play')
  play(@Param('id') id: string): Promise<PlayResponse> {
    return this.channelsService.play(id);
  }
}
