...
import tv.mbolo.app.core.JankMetrics
import tv.mbolo.app.core.LowRamDetector
import tv.mbolo.app.core.MboloRepository
import tv.mbolo.app.core.NetworkInfo
import tv.mbolo.app.core.Telemetry
import tv.mbolo.app.core.TileUi
import tv.mbolo.app.ui.AccessViewModel
import tv.mbolo.app.ui.BrowseMode
import tv.mbolo.app.ui.BrowseViewModel
import tv.mbolo.app.ui.HomeRowAdapter
import tv.mbolo.app.ui.HomeViewModel
import tv.mbolo.app.ui.NativeImages
import tv.mbolo.app.ui.PlayerActivity
import tv.mbolo.app.ui.PlayerViewModel
import tv.mbolo.app.ui.TileAdapter
import tv.mbolo.app.ui.VmFactory
...
class MainActivity : ComponentActivity() {
        ...
        screenJob = lifecycleScope.launch {
            vm.state.collect { s ->
                ...
                if (s.loading) {
                    ...
                    adapter.submitList(s.rows.map { tv.mbolo.app.ui.HomeRowUi(it.title, it.tiles) })
    ...
    private fun onTile(t: TileUi) {
        when (t.kind) {
            ...
            "external" -> {
                val p = t.payload as? tv.mbolo.app.core.ExternalSource
