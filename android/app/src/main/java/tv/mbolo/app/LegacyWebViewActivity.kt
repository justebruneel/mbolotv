...
/**
 * FALLBACK TEMPORAIRE (Phase 5 §51) : ancien wrapper WebView mobile repris
 * verbatim (classe renommée, layout dupliqué). Accessible depuis l'UI native
 * via « Secours web ». À SUPPRIMER uniquement après validation réelle du
 * chemin natif sur appareils cibles.
 */
